package com.example.demo.kafka_demo_example;
...
public class KafkaDemoExampleApplication {
	...
	public static void main(String[] args) throws Exception{
		...
		ConfigurableApplicationContext context = SpringApplication.run(KafkaDemoExampleApplication.class, args);
		...
		/*
		 * Sending a Hello World message to topic 'example_kafka_topic'.
		 ...
		 */
		producer.sendGreetingMessage(new KafkaGreeting("Greetings", "World!"));
	...
	public static class MessageProducer {
		...
		@Autowired
		private KafkaTemplate<String, KafkaGreeting> greetingKafkaTemplate;
		...
		public void sendGreetingMessage(KafkaGreeting greeting) {
	...
	public static class MessageListener {
		...
		public void greetingListener(KafkaGreeting greeting) {
